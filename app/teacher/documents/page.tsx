        ...
        <div className="w-full p-10 bg-gray-50 min-h-screen">
            ...
            <Card shadow="lg" className="mb-10">
                <CardBody className="p-8">
                    <h1 className="text-3xl font-extrabold text-campus-text-primary">
            ...
            <div className="grid grid-cols-3 gap-4 mb-10">
                ...
                <Card shadow="sm">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-campus-text-primary">0</h3>
                ...
                <Card shadow="sm">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-campus-text-primary">0 MB</h3>
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                <Card shadow="sm" className="col-span-2">
                    ...
                    <h2 className="text-lg font-semibold text-campus-text-primary mb-4">Document Library</h2>

                    <div className="w-full h-[350px] bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-center text-campus-text-tertiary">
                ...
                <Card shadow="sm">
                    <CardBody className="p-5">
                    <h2 className="text-lg font-semibold text-campus-text-primary mb-4">Document Details</h2>

                    <div className="w-full h-[350px] flex flex-col items-center justify-center text-campus-text-tertiary">
            ...
            <Card shadow="sm" className="mt-10">
                ...
                <h2 className="text-lg font-semibold text-campus-text-primary mb-4">Storage Analytics</h2>

                <div className="w-full bg-gray-200 h-3 rounded-full mb-2">
                    <div className="bg-blue-600 h-3 rounded-full" style={{ width: "0%" }}></div>
                </div>

                <div className="flex justify-between text-sm text-campus-text-secondary">
